...
type LinkedAccountWithMetadata = User['linked_accounts'][number];
type OAuthFlowState = {
    status: 'initial';
} | {
    status: 'loading';
...
type IEmbeddedSolanaWalletConnectedState = {
    status: 'connected';
    /**
     * @deprecated instead, use `publicKey` from `ConnectedEmbeddedSolanaWallet`.
     *
     * **NOTE: This field will be incorrect/inconsistent for any users with multiple embedded solana wallets**
     *
     * @example
     * const {wallets} = useSolanaEmbeddedWallet()
     * wallets[0].publiscKey
     */
    publicKey: string;
};
...
export { AuthLinkSuccessCallback as A, isConnecting as B, CreateOrRecoverEmbeddedWalletProps as C, isDisconnected as D, ErrorCallback as E, FarcasterFlowState as F, GenerateSiweMessage as G, isNotCreated as H, isCreating as I, hasError as J, needsRecovery as K, LinkFarcasterInput as L, MfaConfig as M, PasskeyLinkHookOptions as N, OtpLinkHookOptions as O, PasskeyFlowState as P, PasskeyHookResult as Q, RecoveryFlowState as R, SiweFlowState as S, PasskeyLoginHookOptions as T, User as U, WalletRecoveryCallbacks as W, AuthSuccessCallback as a, OtpLinkHookResult as b, OtpLoginHookOptions as c, OtpLoginHookResult as d, SubmitFarcasterOptions as e, LoginWithFarcasterInput as f, OAuthHookOptions as g, EmbeddedWalletState as h, EmbeddedSolanaWalletState as i, OtpFlowState as j, OAuthFlowState as k, SolanaWalletRecoveryCallbacks as l, EmbeddedWallet as m, LinkedAccountWithMetadata as n, CreateEthereumEmbeddedWalletOpts as o, RecoverEthereumEmbeddedWalletOpts as p, CreateSolanaEmbeddedWalletOpts as q, RecoverSolanaEmbeddedWalletOpts as r, SetRecoveryProps as s, CustomAuthFlowState as t, EmbeddedWalletActions as u, EmbeddedWalletStatus as v, EmbeddedSolanaWalletActions as w, EmbeddedSolanaWalletStatus as x, isConnected as y, isReconnecting as z };
