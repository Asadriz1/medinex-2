...
import Privy__default, { OAuthProviderType, MfaMethod, PrivyEmbeddedWalletProvider, PrivyEmbeddedSolanaWalletProvider, EmbeddedBitcoinWalletProvider, Storage, Chain, SolanaCluster } from '@privy-io/js-sdk-core';
 ...
 */
declare const PrivyElements: () => React.JSX.Element;
 ...
 */
declare const createPrivyClient: ({ appId, clientId, storage, supportedChains, baseUrl, logLevel, }: PrivyOptions) => {
    getAccessToken: () => Promise<string | null>;
    getIdentityToken: () => Promise<string | null>;
};

export { EmbeddedSolanaWalletState, EmbeddedWalletState, FundingAsset, FundingConfig, FundingSolanaConfig, LinkWithEmailHookResult, LinkWithEmailOptions, LinkWithOAuthInput, LinkWithSMSHookResult, LinkWithSMSOptions, LoginUIConfig, LoginWithEmailHookResult, LoginWithEmailOptions, LoginWithOAuthInput, LoginWithSMSHookResult, LoginWithSMSOptions, MfaConfig, OAuthFlowHookResult, OAuthFlowState, OAuthTokens, OtpFlowState, PrivyContext, PrivyElements, PrivyOptions, PrivyProvider, PrivyProviderProps, PrivyUIError, RecoveryFlowState, SecureStorageAdapter, UseCreateGuestAccount, UseCreateGuestAccountOptions, UseFundSolanaWallet, UseFundWallet, UseLinkWithFarcaster, UseLinkWithFarcasterOptions, UseLinkWithOAuth, UseLinkWithSiwe, UseLinkWithSiweOptions, UseLoginInterface, UseLoginWithFarcaster, UseLoginWithFarcasterOptions, UseLoginWithOAuth, UseLoginWithSiwe, UseLoginWithSiweOptions, UseMfa, UseMfaEnrollment, UseOAuthTokens, UseOAuthTokensOptions, UseOnEmbeddedWalletStateChange, UseRecoverEmbeddedWallet, UseSetEmbeddedWalletRecovery, UseSignMessageInterface, UseSolanaSignMessageInterface, UseUnlinkFarcaster, UseUnlinkFarcasterOptions, UseUnlinkWallet, UseUnlinkWalletOptions, createPrivyClient, getAccessToken, useCreateGuestAccount, useEmbeddedBitcoinWallet, useEmbeddedSolanaWallet, useEmbeddedWallet, useEmbeddedWalletStateChange, useFundSolanaWallet, useFundWallet, useIdentityToken, useLinkEmail, useLinkSMS, useLinkWithFarcaster, useLinkWithOAuth, useLinkWithSiwe, useLogin, useLoginWithEmail, useLoginWithFarcaster, useLoginWithOAuth, useLoginWithSMS, useLoginWithSiwe, useMfa, useMfaEnrollment, useOAuthFlow, useOAuthTokens, usePrivy, usePrivyClient, useRecoverEmbeddedWallet, useRegisterMfaListener, useSetEmbeddedWalletRecovery, useSignMessage, useSolanaSignMessage, useUnlinkFarcaster, useUnlinkOAuth, useUnlinkWallet };
